...
{
    [ControlType("TabClassic")]
    public class DlkTabClassic : DlkBaseControl
    {
        private String mstrLastURL = "";
        private String mstrTabItemsXPATH = ".//a[contains(@class,'navLink')]"; //expects a parent table element
        private List<DlkBaseControl> mlstTabs;

        public DlkTabClassic(String ControlName, String SearchType, String SearchValue)
            : base(ControlName, SearchType, SearchValue) { }
        public DlkTabClassic(String ControlName, String SearchType, String[] SearchValues)
            : base(ControlName, SearchType, SearchValues) { }
        public DlkTabClassic(String ControlName, DlkBaseControl ParentControl, String SearchType, String SearchValue)
        ...
        {
            IList<IWebElement> lstTabElements;
            lstTabElements = mElement.FindElements(By.CssSelector(mstrTabItemsXPATH));
            foreach (IWebElement tabElement in lstTabElements)
            {
        ...
        public void VerifyTabs(String TabNames)
        {
            ...
            this.PerformAction(() =>
            {
                ...
                {
                    DlkLogger.LogInfo("VerifyTabs() passed : Actual List = " + strTabList + " and Expected List = " + tabNames + " are equal");
                }
                else
                {
                    throw new Exception("VerifyTabs() failed : Actual List = " + strTabList + " and Expected List = " + tabNames + " are not equal");
                }
            }, new String[]{"retry"});
        }
        #endregion
