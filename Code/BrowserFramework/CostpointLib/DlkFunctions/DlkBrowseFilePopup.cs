    ...
    public static class DlkBrowseFilePopup
    {
        ...
        public static void ClickBrowse()
        {
            try
            {
                ...
                {                    
                    DlkLogger.LogInfo("ClickBrowse() : Retry using coordinates..");
                    DlkBaseControl btnBrowseFileControl = new DlkBaseControl("BrowseFile", "ID", "browseEdit");
                    btnBrowseFile.FindElement();
                    btnBrowseFile.ClickByObjectCoordinates();
                }
            }
            catch (Exception e)
            {
