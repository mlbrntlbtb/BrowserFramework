    ...
    public class DlkComboBoxList : DlkBaseControl
    {
        ...
        public void SelectItemWithoutVerify(String Value, bool IsStrict = true, bool isMenuMobile = false)
        {
            ...
            try
            {
                ...
                {
                    IReadOnlyCollection<IWebElement> matches = mElement.FindElements(By.XPath("./descendant::div[contains(text(), '" + Value + "')]"));
                    if (matches.Count == 0)
                    {
                        throw new Exception();
                    }
                    ...
                    {
                        ctl = new DlkComboBoxListItem("ItemToSelect", this, "xpath", "./descendant::div[contains(text(), '" + Value + "')]");
                    }
                    else
                    {
