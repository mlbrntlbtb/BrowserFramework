...
{
    public class EMP_CreateDeleteEmployee_01 : TestScript
    {
        public override bool TestExecute(out string ErrorMessage)
        {
            ...
            try
            {
                ...
                cmbLCLevel3.Click();
                Thread.Sleep(1000);
                Control menuLaborCode3 = new Control("LC3Menu", "xpath", "(//div[@class='search-name'][.='00/General'])[2]");
