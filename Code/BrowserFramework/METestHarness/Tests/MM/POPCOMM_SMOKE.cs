...
if (formBttn!=null) { new Control("FormButton",formBttn).MouseOver(); formBttn.Click(); }
			...
			CPCommon.AssertEqual(true,POPCOMM_MainForm_Table.Exists());
				...
				CPCommon.CurrentComponent = "POPCOMM";
							CPCommon.WaitControlDisplayed(POPCOMM_MainForm);
formBttn = POPCOMM_MainForm.mElement.FindElements(By.CssSelector("*[title*='Form']")).Count <= 0 ? POPCOMM_MainForm.mElement.FindElements(By.XPath(".//*[contains(text(),'Form')]")).FirstOrDefault() :
