...
if (formBttn!=null) { new Control("FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				CPCommon.CurrentComponent = "ARMCUST";
							CPCommon.AssertEqual(true,ARMCUST_MainForm.Exists());
...
mTab.Click();
			...
			Driver.SessionLogger.WriteLine("[ARMCUST] Perfoming VerifyExists on Customer_DefaultAcctsLink...", Logger.MessageType.INF);
			Control ARMCUST_Customer_DefaultAcctsLink = new Control("Customer_DefaultAcctsLink", "ID", "lnk_1002896_CPMCUST_CUST_HDR");
			CPCommon.AssertEqual(true,ARMCUST_Customer_DefaultAcctsLink.Exists());
...
if (formBttn!=null) { new Control("FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				CPCommon.CurrentComponent = "ARMCUST";
							CPCommon.AssertEqual(true,ARMCUST_DefaultAcctsForm.Exists());
...
formBttn = ARMCUST_DefaultAcctsForm.mElement.FindElements(By.CssSelector("*[title*='Close']")).Where(x=>x.Displayed).FirstOrDefault();
	if(formBttn!=null) formBttn.Click();
			...
			Driver.SessionLogger.WriteLine("[ARMCUST] Perfoming VerifyExists on Customer_NotesLink...", Logger.MessageType.INF);
			Control ARMCUST_Customer_NotesLink = new Control("Customer_NotesLink", "ID", "lnk_1002897_CPMCUST_CUST_HDR");
			CPCommon.AssertEqual(true,ARMCUST_Customer_NotesLink.Exists());
...
ARMCUST_Customer_NotesLink.Click(1.5);
			...
			Driver.SessionLogger.WriteLine("[ARMCUST] Perfoming VerifyExists on NotesForm...", Logger.MessageType.INF);
			...
			CPCommon.AssertEqual(true,ARMCUST_NotesForm.Exists());
...
formBttn = ARMCUST_NotesForm.mElement.FindElements(By.CssSelector("*[title*='Close']")).Where(x=>x.Displayed).FirstOrDefault();
	if(formBttn!=null) formBttn.Click();
												...
												Driver.SessionLogger.WriteLine("Multi Currency");
			...
			Driver.SessionLogger.WriteLine("[ARMCUST] Perfoming VerifyExists on Customer_MulticurrencyLink...", Logger.MessageType.INF);
			Control ARMCUST_Customer_MulticurrencyLink = new Control("Customer_MulticurrencyLink", "ID", "lnk_1002898_CPMCUST_CUST_HDR");
			CPCommon.AssertEqual(true,ARMCUST_Customer_MulticurrencyLink.Exists());
...
ARMCUST_Customer_MulticurrencyLink.Click(1.5);
			...
			Driver.SessionLogger.WriteLine("[ARMCUST] Perfoming VerifyExists on MulticurrencyForm...", Logger.MessageType.INF);
			...
			CPCommon.AssertEqual(true,ARMCUST_MulticurrencyForm.Exists());
...
formBttn = ARMCUST_MulticurrencyForm.mElement.FindElements(By.CssSelector("*[title*='Close']")).Where(x=>x.Displayed).FirstOrDefault();
	if(formBttn!=null) formBttn.Click();
			...
			Driver.SessionLogger.WriteLine("[ARMCUST] Perfoming VerifyExists on Customer_UserDefinedInfoLink...", Logger.MessageType.INF);
			Control ARMCUST_Customer_UserDefinedInfoLink = new Control("Customer_UserDefinedInfoLink", "ID", "lnk_1007191_CPMCUST_CUST_HDR");
			CPCommon.AssertEqual(true,ARMCUST_Customer_UserDefinedInfoLink.Exists());
...
if (formBttn!=null) { new Control("FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				CPCommon.CurrentComponent = "ARMCUST";
							CPCommon.AssertEqual(true,ARMCUST_UserDefinedInfoForm.Exists());
...
formBttn = ARMCUST_UserDefinedInfoForm.mElement.FindElements(By.CssSelector("*[title*='Close']")).Where(x=>x.Displayed).FirstOrDefault();
	if(formBttn!=null) formBttn.Click();
			...
			Driver.SessionLogger.WriteLine("[ARMCUST] Perfoming VerifyExists on Customer_CustomerAliasLink...", Logger.MessageType.INF);
			Control ARMCUST_Customer_CustomerAliasLink = new Control("Customer_CustomerAliasLink", "ID", "lnk_3565_CPMCUST_CUST_HDR");
			CPCommon.AssertEqual(true,ARMCUST_Customer_CustomerAliasLink.Exists());
...
ARMCUST_Customer_CustomerAliasLink.Click(1.5);
			...
			Driver.SessionLogger.WriteLine("[ARMCUST] Perfoming VerifyExists on CustomerAlias_Ok...", Logger.MessageType.INF);
			Control ARMCUST_CustomerAlias_Ok = new Control("CustomerAlias_Ok", "xpath", "//div[translate(@id,'0123456789','')='pr__CPMCUST_CUSTALIAS_CTW_']/ancestor::form[1]/following-sibling::div[1]/descendant::*[@id='bOk']");
			CPCommon.AssertEqual(true,ARMCUST_CustomerAlias_Ok.Exists());
...
formBttn = ARMCUST_CustomerAliasForm.mElement.FindElements(By.CssSelector("*[title*='Close']")).Where(x=>x.Displayed).FirstOrDefault();
	if(formBttn!=null) formBttn.Click();
											...
											Driver.SessionLogger.WriteLine("Customer Address");
...
if (formBttn!=null) { new Control("FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				CPCommon.CurrentComponent = "ARMCUST";
							CPCommon.AssertEqual(true,ARMCUST_CustomerAddressForm.Exists());
			...
			Driver.SessionLogger.WriteLine("[ARMCUST] Perfoming VerifyExists on CustomerAddress_ContactsLink...", Logger.MessageType.INF);
			...
			CPCommon.AssertEqual(true,ARMCUST_CustomerAddress_ContactsLink.Exists());
...
if (formBttn!=null) { new Control("FormButton",formBttn).MouseOver(); formBttn.Click(); }
				...
				CPCommon.CurrentComponent = "ARMCUST";
							CPCommon.AssertEqual(true,ARMCUST_ContactsForm.Exists());
