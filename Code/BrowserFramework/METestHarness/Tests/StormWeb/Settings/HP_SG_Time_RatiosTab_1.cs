...
{
    public class HP_SG_Time_RatiosTab_1 : TestScript
    {
        public override bool TestExecute(out string ErrorMessage)
        {
            ...
            try
            {
                ...
                //6. Set Checkbox value - Target to True
                ...
                //7. Set Checkbox value - Direct Standard to True
                var CB_DirectStandard = new Control("CB_DirectStandard", "XPATH", "//*[@name='ShowRatio2']");
                if (CB_DirectStandard.GetAttributeValue("checked") != "true")
                {
                    CB_DirectStandard.Click();
                }

                //8. Set Checkbox value - Direct Standard Absence to True
                ...
                //9. Set Checkbox value - Current to False
                ...
                //10. Set Checkbox value - Month-To-Date to False
                ...
                //11. Set Checkbox value - Quarter-To-Date to False
                ...
                //12. Set Checkbox value - Year-To-Date to False
