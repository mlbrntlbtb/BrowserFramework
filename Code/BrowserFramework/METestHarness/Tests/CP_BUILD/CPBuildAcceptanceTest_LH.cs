...
{
    public class CPBuildAcceptanceTest_LH : TestScript
    {
        public override bool TestExecute(out string ErrorMessage, string TestEnvironment)
        {
			...
			try
			{
                ...
                {
                    throw new Exception("Error navigating to Rebuild Global Settings app [ln 43]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Re-load Settings. [ln 62]" + ex.Message);
                }
                ...
                {
                    throw new Exception("Error waiting for process to finish. [ln 73]" + ex.Message);
                }
                ...
                {
                    throw new Exception("Error verifying Process Progress header [ln 87]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Process Progress OK button [ln 106]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error closing SYPSTNG main form [ln 125]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking message box OK button [ln 137]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error navigating to Manage Users app [ln 157]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error setting UserId in SYMUSR app [ln 174]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error setting UserName in SYMUSR app [ln 191]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error setting Deafult Company in SYMUSR app [ln 208]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking New button in SYMUSR Company Access form [ln 229]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Form button in SYMUSR Company Access Form [ln 248]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error setting Company ID in SYMUSR app [ln 265]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error setting Default Taxable Entity ID in SYMUSER app [ln 281]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error setting Org Sec ID in SYMUSER app [ln 299]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Authentication tab in SYMUSER app [ln 319]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error setting CP password in SYMUSER app [ln 336]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error setting Verify Password in SYMUSER app [ln 353]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Save and Continue. [ln 371]" + ex.Message);
                }
                ...
                {
                    throw new Exception("Error verifying save message [ln 385]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Save and Continue [ln 402]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error verifying save message [ln 416]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Horizontal Layout [ln 435]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error waiting for process to finish. [ln 447]" + ex.Message);
                }
                ...
                {
                    throw new Exception("Error verifying process progress header [ln 462]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Process Progress OK button [ln 477]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error downloading file [ln 489]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Delete in SYMUSR app [ln 515]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error clicking Save [ln 532]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error verifying save message [ln 546]. " + ex.Message);
                }
                ...
                {
                    throw new Exception("Error closing SYMUSR main form [ln 563]. " + ex.Message);
                }
