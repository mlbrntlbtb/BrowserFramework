...
namespace StormWebLib.DlkUtility
{
    public class DlkStormWebControlHelper : DlkControlHelper
    {
        ...
        public override string DetectControlType(DlkBaseControl control)
        {
            ...
            if (mTab.VerifyControlType())
                return "Tab";
            mMultiselect = new DlkMultiselect("Multiselect", control.mElement);
            if (mMultiselect.VerifyControlType())
                return "Multiselect";     
            return "";
        ...
        public override void AutoCorrectSearchMethod(DlkBaseControl control, string controlType, ref string SearchType, ref string SearchValue)
        {
            ...
            switch (controlType.ToLower())
            {
                ...
                case "multiselect":
                    mMultiselect = new DlkMultiselect("Multiselect", control.mElement);
                    mMultiselect.AutoCorrectSearchMethod(ref SearchType, ref SearchValue);
                    break;
