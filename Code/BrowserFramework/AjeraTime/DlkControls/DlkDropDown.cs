...
namespace AjeraTimeLib.DlkControls
{
    ...
    public class DlkDropDown : DlkAjeraTimeBaseControl
    {
        #region DECLARATIONS
    ...
    public class DlkDropDownItemList : DlkAjeraTimeBaseControl
    {
        #region DECLARATIONS
        /*
        ...
        public void SelectItemFromList(String Value)
        {
            ...
            foreach (var option in mSelection.Options)
            {
                ...
                if (option.Text.ToLower() == Value.ToLower())
                {
                    ...
                    _actualValueSelected = mSelection.SelectedOption.Text;
                    bFound = true;
                    break;
                }
            }
