...
namespace BPMLib.DlkControls
{
    ...
    public class DlkLabel : DlkBaseControl
    {
        ...
        [Keyword("VerifyContains", new String[] { "1|text|Text To Verify|Sample Label Text" })]
        public void VerifyContains(String TextToVerify)
        {
            try
            {
                Initialize();
                ...
                DlkAssert.AssertEqual("VerifyContains() : " + mControlName, textToVerify, actualResult, true);
            }
            catch (Exception e)
            {
                throw new Exception("VerifyContains() failed : " + e.Message, e);
            }
            finally
            {
                Terminate();
