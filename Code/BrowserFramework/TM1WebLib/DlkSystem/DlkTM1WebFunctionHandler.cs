...
namespace TM1WebLib.System
{
    ...
    public static class DlkTM1WebFunctionHandler
    {
        /// <summary>
            ...
            else
            {
                switch (Screen)
                {
                    ...
                    case "Login":
                        ...
                        {
                            case "Login":
                                DlkLogin.Login(Parameters[0], Parameters[1], Parameters[2]);
                                break;
                            default:
        ...
        public static void IfThenElse(String VariableValue, String Operator, String ValueToTest, String IfGoToStep, String ElseGoToStep)
        {
            ...
            switch (Operator)
            {
                case "=":
                    ...
                    DlkTM1WebTestExecute.mGoToStep = (iGoToStep - 1); // steps are zero based
