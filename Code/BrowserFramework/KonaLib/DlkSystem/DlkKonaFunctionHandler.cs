...
namespace KonaLib.System
{
    ...
    public static class DlkKonaFunctionHandler
    {
        /// <summary>
            ...
            else
            {
                switch (Screen)
                {
                    ...
                    case "Login":
                        ...
                        {
                            case "Login":
                                DlkLogin.Login(Parameters[0], Parameters[1]);
                                break;
                            default:
        ...
        public static void IfThenElse(String VariableValue, String Operator, String ValueToTest, String IfGoToStep, String ElseGoToStep)
        {
            ...
            switch (Operator)
            {
                case "=":
                    ...
                    DlkKonaTestExecute.mGoToStep = (iGoToStep - 1); // steps are zero based
