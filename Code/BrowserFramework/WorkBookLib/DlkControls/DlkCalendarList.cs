...
{
    [ControlType("CalendarList")]
    public class DlkCalendarList : DlkBaseControl
    {
        #region CONSTRUCTORS
        public DlkCalendarList(String ControlName, String SearchType, String SearchValue)
            : base(ControlName, SearchType, SearchValue) { }
        public DlkCalendarList(String ControlName, String SearchType, String[] SearchValues)
            : base(ControlName, SearchType, SearchValues) { }
        public DlkCalendarList(String ControlName, DlkBaseControl ParentControl, String SearchType, String SearchValue)
            : base(ControlName, ParentControl, SearchType, SearchValue) { }
        public DlkCalendarList(String ControlName, IWebElement ExistingWebElement)
