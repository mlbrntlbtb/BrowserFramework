...
namespace WorkBookLib.DlkControls
{
    ...
    public class DlkColorPicker : DlkBaseControl
    {
        #region CONSTRUCTORS
        public DlkColorPicker(String ControlName, String SearchType, String SearchValue)
            : base(ControlName, SearchType, SearchValue) { }
        public DlkColorPicker(String ControlName, String SearchType, String[] SearchValues)
            : base(ControlName, SearchType, SearchValues) { }
        public DlkColorPicker(String ControlName, DlkBaseControl ParentControl, String SearchType, String SearchValue)
            : base(ControlName, ParentControl, SearchType, SearchValue) { }
        public DlkColorPicker(String ControlName, IWebElement ExistingWebElement)
