...
{
    [ControlType("Gantt")]
    public class DlkGantt : DlkBaseControl
    {
        #region CONSTRUCTORS
        public DlkGantt(String ControlName, String SearchType, String SearchValue)
            : base(ControlName, SearchType, SearchValue) { }
        public DlkGantt(String ControlName, String SearchType, String[] SearchValues)
            : base(ControlName, SearchType, SearchValues) { }
        public DlkGantt(String ControlName, DlkBaseControl ParentControl, String SearchType, String SearchValue)
            : base(ControlName, ParentControl, SearchType, SearchValue) { }
        public DlkGantt(String ControlName, IWebElement ExistingWebElement)
