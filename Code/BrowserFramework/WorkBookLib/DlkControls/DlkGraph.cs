...
{
    [ControlType("Graph")]
    public class DlkGraph : DlkBaseControl
    {
        #region CONSTRUCTORS
        public DlkGraph(String ControlName, String SearchType, String SearchValue)
            : base(ControlName, SearchType, SearchValue) { }
        public DlkGraph(String ControlName, String SearchType, String[] SearchValues)
            : base(ControlName, SearchType, SearchValues) { }
        public DlkGraph(String ControlName, DlkBaseControl ParentControl, String SearchType, String SearchValue)
            : base(ControlName, ParentControl, SearchType, SearchValue) { }
        public DlkGraph(String ControlName, IWebElement ExistingWebElement)
