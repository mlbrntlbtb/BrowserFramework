...
namespace SBCLib.DlkFunctions
{
    ...
    public static class DlkDialog
    {
        ...
        [Keyword("ClickOkDialogWithMessagePart", new String[] { "1|text|Expected Part of Message|Sample message part" })]
        public static void ClickOkDialogWithMessagePart(String PartOfMessage)
        {
            DlkAlert.ClickOkDialogWithMessagePart(PartOfMessage);
        }
